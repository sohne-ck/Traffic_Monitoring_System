...
model.load_weights(dir_path+"/hyperlpr_py3/model/char_judgement1.h5")
# model.save("./model/char_judgement1.h5")
model2.load_weights(dir_path+"/hyperlpr_py3/model/char_judgement.h5")
...
from hyperlpr_py3.recognizer import SimplePredict

# from . import niblack_thresholding as nt
from hyperlpr_py3.niblack_thresholding import niBlackThreshold
