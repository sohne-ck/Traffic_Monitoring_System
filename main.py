...
from lprmix import lprCar          # loading the function to learn the text of the car
...
ap.add_argument("-i", "--input",help="path to input video", default = "./test_video/video-01.avi")
...
def main(yolo):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            cv2.putText(frame,str(track.track_id)+class_name,(int(bbox[0]), int(bbox[1] -10)),0, 5e-3 * 150, (color),2)
